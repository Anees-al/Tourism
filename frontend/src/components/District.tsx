...
const District = () => {
  ...
  const places: TravelDestination[] = [
    ...
    { name: 'Alappuzha', description: 'The Venice of the East Immerse yourself in a labyrinth of palm-fringed canals, emerald lagoons, and the rhythmic pulse of the backwaters. Famous for its iconic houseboats and the legendary Nehru Trophy Snake Boat Race, Alappuzha is the heart of Kerala’s tranquil aquatic soul.', imageUrl:alapuzha,link:""  },
    ...
    { name: 'Edukki', description: 'The Wild Highland Sanctuary High in the Western Ghats, Idukki is a land of sheer cliffs, massive dams, and deep wildlife sanctuaries. Home to the towering Idukki Arch Dam and the misty peaks of Munnar, it is a region where raw nature meets engineering marvels amidst a landscape of spice gardens and cloud-kissed valleys.', imageUrl:edukki,link:""  },
    { name: 'Ernakulam', description: 'The Pulse of Modern Kerala Where ancient heritage meets a soaring skyline, Ernakulam is the vibrant gateway to the state. From the bustling shopping hubs of MG Road to the serene marine walkways overlooking the Arabian Sea, it is a city of high-energy commerce, luxury harbors, and the starting point for every traveler’s Kerala adventure.', imageUrl:earnakulam,link:""  },
    { name: 'Thrissur', description: 'The Cultural Pulse of Kerala Built around a sprawling hillock, Thrissur is the vibrant home of Kerala’s soul. Famous for the world-renowned Thrissur Pooram, it is a city of grand elephants, majestic temples, and traditional performing arts. Here, the air is thick with the sound of rhythmic percussion and the scent of temple festivals.', imageUrl:thrissur,link:""  },
    { name: 'Palakkad', description: 'The Gateway of the Western Ghats Nestled at the foot of the massive Palakkad Gap, this is where the winds of the plains meet the lush forests of the mountains. A land of vast golden paddy fields and ancient granite forts, Palakkad offers a unique blend of Kerala greenery and the rustic charm of rural traditions.', imageUrl:palakkad,link:""  },
    { name: 'Kozhikode', description: 'The Coast of Discovery Where Vasco da Gama first stepped onto Indian soil, Kozhikode remains a legendary port of trade and tradition. Known for its soul-stirring sunsets at Kappad Beach and its world-famous Malabar cuisine, it is a city where historic spice routes meet a modern, warm-hearted culture of unmatched hospitality.', imageUrl:kozhikode,link:""  },
    { name: 'Malappuram', description: 'The Soul of Malabar Perched atop the undulating hills of North Kerala, Malappuram is a land of vibrant traditions and heroic history. From the scenic teak forests of Nilambur to the sacred shores of the Bharathapuzha river, it is a region where cultural harmony, ancient Ayurveda, and a legendary passion for football create a unique and spirited atmosphere.', imageUrl:malappuram,link:""  },
    { name: 'Kannur', description: 'The Land of Looms and Lores Experience a world where history is carved into massive forts and spirituality comes alive through the mystical Theyyam rituals. From the sprawling ramparts of St. Angelo Fort to the unique drive-in beach at Muzhappilangad, Kannur is a captivating blend of ancient colonial legacy and vibrant folk traditions.', imageUrl:kannur,link:""  },
    { name: 'Wayanad', description: 'The Green Paradise Perched high on the Western Ghats, Wayanad is a breathtaking highland escape where the air is scented with wild coffee and spices. Wander through mist-covered valleys, explore ancient Neolithic caves, and witness wild elephant corridors in a land that remains Kerala’s most pristine nature retreat.', imageUrl: wayanadu,link:"" },
    { name: 'Kasaragod', description: 'The Northern Frontier Perched at the very edge of Kerala, Kasaragod is a captivating land of majestic forts and untouched coastlines. Dominated by the giant keyhole-shaped Bekal Fort—the largest in the state—it is a destination where the Arabian Sea crashes against ancient stone walls and the backwaters of Valiyaparamba offer a secluded, serene escape.', imageUrl:kasarkode,link:""  }
  ]
